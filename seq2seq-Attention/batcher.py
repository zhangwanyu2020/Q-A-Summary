...
def get_dec_inp_targ_seqs(sequence, max_len, start_id, stop_id, pad_id):
    """
...
def example_generator(vocab, train_x_path, train_y_path, test_x_path, max_enc_len, max_dec_len, mode, batch_size):
    ...
    if mode == "train":
        ...
        for raw_record in train_dataset:
            ...
            dec_input, target = get_dec_inp_targ_seqs(abs_ids, max_dec_len, start_decoding, stop_decoding, pad_decoding)
